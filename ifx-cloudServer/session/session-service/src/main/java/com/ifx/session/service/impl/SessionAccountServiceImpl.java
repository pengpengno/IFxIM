...
public class SessionAccountServiceImpl extends ServiceImpl<SessionAccountMapper, SessionAccount>
    ...
    private static final String RELATION_CACHE_KEY_PREFIX= "SESSION:ACCOUNT:";   //账户关系缓存前缀
    ...
    public Set<String> listAccBySessionId(Long sessionId) {
        ...
        List<String> list = cache.get(sessionId.toString(), List.class);
        ...
        cache.set(sessionId.toString(),sessionIds);
        return sessionIds;
    }
